...
> These words were inspired by reading [On Freedom by Timothy Snyder](https://timothysnyder.org/on-freedom) and participating in the discussion around the [revised principles of SSI](https://revisitingssi.com/library/ssi-principles-2026-redline/). The intention is to present an alternative, thought-provoking frame to think through identity and sovereignty in digital environments. Enjoy :)
...
Instead, let us aspire to inhabit our own *rugged borderland of unpredictability[^1]* and create invitations and pathways for others to step into theirs.
...
[^1]: This is a beautiful phrase used throughout Timothy Snyder’s On Freedom. The individually perceived and inhabited human space between what is and what should be. This is the zone of freedom.

[^2]: Predictification is a great word that Snyder uses to describe the state when we let our machines define us by our most probable states. They predictify us.

![AI generated - Inspired by these words and my previous attempts at rendering this complexity. See https://iiexhibition.studio/exhibit/1 .](/posts/sovereignty-over-our-digital-selves/image-1.jpg)

*AI generated - Inspired by these words and my previous attempts at rendering this complexity. See https://iiexhibition.studio/exhibit/1 .*
